...
public class RecyclerItemTouchHelper extends ItemTouchHelper.SimpleCallback {
    ...
    @Override
    public void onChildDraw(Canvas canvas, RecyclerView recyclerView, RecyclerView.ViewHolder viewHolder, float dX, float dY, int actionState, boolean isCurrentActive){
